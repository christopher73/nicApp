...
import { StyleSheet, ImageBackground, Text, View, TouchableOpacity, TextInput, KeyboardAvoidingView, Keyboard } from 'react-native';
    ...
    <ImageBackground source={require('../../assets/background.jpg')} style={styles.backgroundImage}>
      <View style={styles.containerDiv}>
        ...
        <View style={styles.buttonDiv}>
          <Hr text="Sign in" fontSize={5} lineColor="#eee" textPadding={5} textStyles={{ fontSize: 20, marginVertical: 12, color: 'white' }} hrStyles={{ color: 'white' }} />
          <TextInput onSubmitEditing={Keyboard.dismiss} autoFocus={false} style={styles.textInput} autoCompleteType={'email'} onChangeText={text => setEmail(text)} placeholder="Your email" placeholderTextColor="white" />
          <TextInput
          ...
          <Hr text="or" fontSize={5} lineColor="#eee" textPadding={5} textStyles={{ fontSize: 20, marginVertical: 12, color: 'white' }} hrStyles={{ color: 'white' }} />
